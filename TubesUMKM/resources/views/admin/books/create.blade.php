...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-6">
        ...
        <p class="mt-2 text-gray-600">Isi formulir di bawah untuk menambahkan produk buku baru</p>
    </div>
    ...
    <!-- Form -->
    <form action="{{ route('admin.books.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-md p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                <label for="cover_image" class="block text-sm font-medium text-gray-700 mb-2">
                    Cover Buku (URL atau Upload)
                </label>
                <input type="text" 
                       name="cover_image" 
                       id="cover_image" 
                       value="{{ old('cover_image') }}"
                       placeholder="https://example.com/cover.jpg atau upload file"
                ...
                <input type="file" 
                       ...
                       accept="image/*"
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                <p class="text-xs text-gray-500 mt-1">Bisa masukkan URL gambar atau upload file gambar</p>
            </div>
